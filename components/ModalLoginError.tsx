...
const volverAlLogin = () => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
      <div className="bg-white border-4 border-blue-500 rounded-lg p-8 text-center w-[400px] shadow-lg">
        <h2 className="text-red-600 font-bold text-xl mb-4">¡LOGIN NO VÁLIDO!</h2>
